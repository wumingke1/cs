...
proxies:
  - {"name":"HK 5G(443端口)_1","type":"vmess","server":"hk5g.xn--vhq70hxyat50h6wk.com","port":443,"cipher":"auto","uuid":"ca99dffd-cfde-47cd-a6fd-6afaaf7eb6fc","alterId":0,"tls":false,"skip-cert-verify":true,"network":"ws","ws-opts":{"path":"/","headers":{"host":"tms.dingtalk.com"}}}
  - {"name":"HK 5G(443端口)_2","type":"vmess","server":"hk5g.xn--vhq70hxyat50h6wk.com","port":443,"cipher":"auto","uuid":"ca99dffd-cfde-47cd-a6fd-6afaaf7eb6fc","alterId":0,"tls":false,"skip-cert-verify":true,"network":"ws","ws-opts":{"path":"/","headers":{"host":"tms.dingtalk.com"}}}
proxy-groups:
  - name: 🚀 节点选择
    type: select
    proxies:
